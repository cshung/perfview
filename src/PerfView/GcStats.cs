...
namespace Stats
{
    internal static class GcStats
    {
        ...
        public static void ToXmlAttribs(TextWriter writer, TraceProcess stats, TraceLoadedDotNetRuntime runtime, TraceGC gc)
        {
            ...
            if (gc.dynamicHeapCountTuning != null)
            {
                writer.Write(" NewHeapCount={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.newHeapCount.ToString("n3"), 10));
                writer.Write(" GCIndex={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.gcIndex.ToString("n3"), 10));
                writer.Write(" MedianPercentOverhead={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.medianPercentOverhead.ToString("n3"), 10));
                writer.Write(" SmoothedMedianPercentOverhead={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.smoothedMedianPercentOverhead.ToString("n3"), 10));
                writer.Write(" OverheadReductionPerStepUp={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.overheadReductionPerStepUp.ToString("n3"), 10));
                writer.Write(" OverheadIncreasePerStepDown={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.overheadIncreasePerStepDown.ToString("n3"), 10));
                writer.Write(" SpaceCostIncreasePerStepUp={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.spaceCostIncreasePerStepUp.ToString("n3"), 10));
                writer.Write(" SpaceCostDecreasePerStepDown={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountTuning.spaceCostDecreasePerStepDown.ToString("n3"), 10));
            }
            if (gc.dynamicHeapCountSample != null)
            {
                writer.Write(" gcElapsedTime={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountSample.gcElapsedTime.ToString("n3"), 10));
                writer.Write(" sohMslWaitTime={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountSample.sohMslWaitTime.ToString("n3"), 10));
                writer.Write(" uohMslWaitTime={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountSample.uohMslWaitTime.ToString("n3"), 10));
                writer.Write(" elapsedBetweenGcs={0}", StringUtilities.QuotePadLeft(gc.dynamicHeapCountSample.elapsedBetweenGcs.ToString("n3"), 10));
            }
            writer.WriteLine(">");
